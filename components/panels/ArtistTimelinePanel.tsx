      ...
      <div className="chart-card">
        ...
        <ResponsiveContainer width="100%" height={350}>
          <AreaChart data={chartData}>
            ...
            <Tooltip contentStyle={{ background: '#12131a', border: '1px solid rgba(255,255,255,0.1)', borderRadius: 8, fontSize: 13 }} formatter={(v: any, name: any) => [formatFullNumber(v), name === 'quantity' ? 'Streams' : name === 'ma4' ? '4W Avg' : '12W Avg']} labelStyle={{ color: '#8b8da3' }} />
